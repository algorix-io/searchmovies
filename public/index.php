...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 py-12 text-center rounded-2xl border border-slate-800 bg-slate-900/50">
      ...
      <?php if($q !== ''): ?>
        <a href="/" class="mt-6 inline-block px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 transition outline-none focus-visible:ring focus-visible:ring-sky-600">Clear search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
