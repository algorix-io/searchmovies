...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-8 text-center py-12 rounded-2xl border border-slate-800 bg-slate-900/50">
      ...
      <p class="text-slate-400 mb-6">Try adjusting your search terms.</p>
      <a href="/" class="inline-block rounded-xl border border-slate-700 px-4 py-2 hover:bg-slate-800 outline-none focus:ring focus:ring-sky-600 transition">Clear search</a>
    </div>
  <?php else: ?>
