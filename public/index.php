...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center">
    ...
    <a href="/" class="inline-block rounded-xl border border-slate-700 bg-slate-800 px-6 py-2 outline-none focus:ring focus:ring-sky-600 hover:bg-slate-700 transition">Clear Search</a>
  </div>
  <?php else: ?>
  <div class="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
    <?php foreach($movies as $m): ?>
      <a href="/movie/<?=h($m['slug'])?>" class="block rounded-2xl overflow-hidden border border-slate-800 outline-none focus:ring focus:ring-sky-600 hover:border-sky-600 transition">
