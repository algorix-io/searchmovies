...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-16 text-center text-slate-400">
      ...
      <p class="mt-2 text-sm">We couldn't find any movies matching your search.</p>
      <?php if($q !== ''): ?>
        <a href="/" class="mt-6 inline-block rounded-xl bg-slate-800 px-5 py-2.5 text-sm font-medium hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition">Clear search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
