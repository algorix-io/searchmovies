...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center">
    ...
    <?php if($q !== ''): ?>
    <div class="mt-6">
      <a href="/" class="inline-block rounded-xl bg-sky-600 text-white px-6 py-2 hover:bg-sky-500 outline-none focus-visible:ring focus-visible:ring-sky-400 transition font-medium">Clear Search</a>
    </div>
    <?php endif; ?>
  </div>
  <?php else: ?>
