...
<header class="border-b border-slate-800 sticky top-0 bg-slate-950/80 backdrop-blur">
  <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <form class="flex gap-2 w-full max-w-lg" method="get">
      ...
      <button class="rounded-xl border border-slate-700 px-4 py-2 outline-none hover:bg-slate-800 focus-visible:ring focus-visible:ring-sky-600 transition" aria-label="Submit search">Search</button>
    </form>
  </div>
</header>
<main class="max-w-6xl mx-auto px-4 py-6">
  <div class="flex items-end justify-between">
    <h1 class="text-2xl font-bold"><?php if($q!=='') echo "Search Results for '".h($q)."'"; else echo "Fresh Movies"; ?></h1>
  ...
  <div class="mt-12 text-center">
    ...
    <?php if($q !== ''): ?>
    <a href="/" class="inline-block mt-6 px-6 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-medium outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear Search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
