...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center py-12 rounded-2xl border border-slate-800 bg-slate-900/50">
      ...
      <a href="/" class="inline-block rounded-xl border border-slate-700 bg-slate-800 px-6 py-2 hover:bg-slate-700 hover:border-slate-600 transition outline-none focus-visible:ring focus-visible:ring-sky-600">Clear search</a>
    </div>
  <?php else: ?>
