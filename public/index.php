...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
  <div class="mt-12 text-center py-12 border border-slate-800 border-dashed rounded-2xl">
    ...
    <?php if($q !== ''): ?>
      <a href="/" class="inline-block mt-6 px-6 py-2 rounded-xl bg-slate-800 text-slate-200 hover:bg-slate-700 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
