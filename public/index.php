...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center">
    ...
    <a href="/" class="inline-block rounded-xl bg-slate-800 border border-slate-700 px-6 py-2 hover:bg-slate-700 hover:border-slate-600 transition outline-none focus-visible:ring focus-visible:ring-sky-600">Clear search</a>
  </div>
  <?php else: ?>
