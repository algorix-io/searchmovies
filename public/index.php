...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
  <div class="mt-8 text-center py-12 bg-slate-900/50 rounded-2xl border border-slate-800">
    ...
    <?php if($q !== ''): ?>
    <div class="mt-6">
      <a href="/" class="inline-block rounded-xl bg-slate-800 border border-slate-700 px-6 py-2 hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition">Clear Search</a>
    </div>
    <?php endif; ?>
  </div>
  <?php else: ?>
