  ...
  <div class="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
    <?php if(empty($movies)): ?>
      <div class="col-span-full py-12 text-center">
        <div class="text-slate-400 mb-4">No movies found matching "<?=h($q)?>".</div>
        <a href="/" class="inline-flex items-center gap-2 rounded-xl border border-slate-700 px-4 py-2 hover:bg-slate-800 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear Search</a>
      </div>
