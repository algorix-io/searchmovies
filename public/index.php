...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 flex flex-col items-center text-center">
    ...
    <?php if($q !== ''): ?>
    <a href="/" class="mt-6 inline-flex items-center gap-2 rounded-xl bg-slate-800 px-4 py-2 font-medium hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition">
      Clear search
    </a>
    <?php endif; ?>
  </div>
