...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(count($movies) === 0 && $q !== ''): ?>
    <div class="mt-12 text-center">
      ...
      <a href="/" class="inline-flex items-center gap-2 rounded-xl bg-sky-600 text-white px-5 py-2.5 hover:bg-sky-500 transition outline-none focus:ring focus:ring-sky-600 focus:ring-offset-2 focus:ring-offset-slate-950 font-medium">Clear Search</a>
    </div>
  <?php else: ?>
