...
<header class="border-b border-slate-800 sticky top-0 bg-slate-950/80 backdrop-blur">
  <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <form class="flex gap-2 w-full max-w-lg" method="get">
      ...
      <button class="rounded-xl border border-slate-700 px-4 py-2 focus:outline-none focus:ring focus:ring-sky-600 hover:bg-slate-800 transition-colors">Search</button>
    </form>
  </div>
</header>
...
<footer class="border-t border-slate-800">
  <div class="max-w-6xl mx-auto px-4 py-6 text-slate-400 text-sm flex flex-wrap items-center gap-3">
    ...
    <span class="footer-tag">Powered by <a href="https://knowhub.uz" target="_blank" rel="noopener" class="underline focus:outline-none focus:ring focus:ring-sky-600 hover:text-sky-400 transition-colors rounded">KnowHub.uz</a></span>
  </div>
</footer>
</body></html>
