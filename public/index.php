...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center py-16 rounded-2xl border border-slate-800/50 bg-slate-900/20">
      ...
      <a href="/" class="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800 px-5 py-2.5 font-medium hover:border-sky-600 hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition">
        Clear Search
      </a>
    </div>
  <?php else: ?>
