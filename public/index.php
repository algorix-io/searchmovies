...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center">
      ...
      <?php if($q !== ''): ?>
        <a href="/" class="inline-block rounded-xl border border-slate-700 px-6 py-2 hover:bg-slate-800 outline-none focus:ring focus:ring-sky-600 transition">Clear Search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
