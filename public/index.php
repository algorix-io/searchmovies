...
<header class="border-b border-slate-800 sticky top-0 bg-slate-950/80 backdrop-blur">
  <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <form class="flex gap-2 w-full max-w-lg" method="get">
      ...
      <button class="rounded-xl border border-slate-700 px-4 py-2 hover:bg-slate-800 outline-none focus-visible:ring focus-visible:ring-sky-600 transition cursor-pointer">Search</button>
    </form>
  </div>
</header>
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-16 text-center">
    ...
    <a href="/" class="inline-flex items-center justify-center rounded-xl bg-slate-800 px-6 py-2.5 font-medium hover:bg-slate-700 outline-none focus-visible:ring focus-visible:ring-sky-600 transition cursor-pointer">Clear search</a>
    <?php else: ?>
    <p class="text-slate-400 mb-6">There are currently no movies available.</p>
    <?php endif; ?>
  </div>
  <?php else: ?>
