...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center text-slate-400">
      ...
      <?php if($q !== ''): ?>
        <a href="/" class="inline-block rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 px-4 py-2 text-slate-200 transition outline-none focus:ring focus:ring-sky-600">Clear search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
