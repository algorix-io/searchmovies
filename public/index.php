...
<footer class="border-t border-slate-800">
  <div class="max-w-6xl mx-auto px-4 py-6 text-slate-400 text-sm flex flex-wrap items-center gap-3">
    ...
    <span class="footer-tag">Powered by <a href="https://knowhub.uz" target="_blank" rel="noopener" class="underline outline-none focus:ring focus:ring-sky-600 rounded p-1">KnowHub.uz</a></span>
  </div>
</footer>
</body></html>
