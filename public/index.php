...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-8 text-center py-12 rounded-2xl border border-slate-800 bg-slate-900/50">
    ...
    <p class="text-slate-400 mb-6">Try adjusting your search query.</p>
    <?php if($q !== ''): ?>
      <a href="/" class="inline-block rounded-xl bg-slate-800 px-4 py-2 hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition-colors">Clear search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
