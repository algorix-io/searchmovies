...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 py-12 text-center rounded-2xl border border-slate-800 bg-slate-900/50">
    ...
    <p class="text-slate-400 max-w-md mx-auto">We couldn't find any movies matching "<?=h($q)?>".</p>
    <?php if($q !== ''): ?>
      <a href="/" class="inline-block mt-6 px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 outline-none focus:ring focus:ring-sky-600 transition">Clear search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
