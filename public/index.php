...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center text-slate-400">
      ...
      <?php if($q !== ''): ?>
        <p class="mt-2">We couldn't find anything matching "<?=h($q)?>".</p>
        <a href="/" class="inline-block mt-4 rounded-xl border border-slate-700 bg-slate-800 hover:bg-slate-700 px-4 py-2 text-slate-200 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear Search</a>
      <?php else: ?>
