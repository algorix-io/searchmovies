...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center py-12 rounded-2xl border border-slate-800 bg-slate-900/50">
    ...
    <a href="/" class="inline-flex items-center gap-2 rounded-xl bg-slate-800 border border-slate-700 px-4 py-2 hover:bg-slate-700 outline-none focus:ring focus:ring-sky-600 transition">
      Clear search
    </a>
  </div>
  <?php else: ?>
