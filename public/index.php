...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-8 flex flex-col items-center justify-center p-8 border border-slate-800 border-dashed rounded-2xl text-center bg-slate-900/50">
      ...
      <a href="/" class="px-6 py-2 bg-slate-800 hover:bg-slate-700 rounded-xl transition outline-none focus:ring focus:ring-sky-600">Clear search</a>
    </div>
  <?php else: ?>
