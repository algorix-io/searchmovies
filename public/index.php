...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-12 text-center">
      ...
      <p class="text-slate-400 mb-6">We couldn't find anything matching "<?=h($q)?>". Try a different search term or browse all movies.</p>
      <?php if($q !== ''): ?>
        <a href="/" class="inline-block rounded-xl bg-slate-800 px-6 py-2 font-medium hover:bg-slate-700 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear Search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
