...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if (empty($movies)): ?>
    <div class="mt-8 text-center bg-slate-900 rounded-2xl p-8 border border-slate-800">
      ...
      <a href="/" class="inline-flex items-center justify-center rounded-xl bg-sky-600 px-4 py-2 text-sm font-medium text-white hover:bg-sky-500 outline-none focus:ring focus:ring-sky-600 focus:ring-offset-2 focus:ring-offset-slate-950 transition-colors">Clear Search</a>
    </div>
  <?php else: ?>
