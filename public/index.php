...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <?php if(empty($movies)): ?>
    <div class="mt-16 flex flex-col items-center justify-center text-center">
      ...
      <?php if($q !== ''): ?>
        <a href="/" class="mt-6 inline-flex items-center gap-2 rounded-xl bg-slate-800 border border-slate-700 px-4 py-2 hover:bg-slate-700 hover:border-slate-600 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear search</a>
      <?php endif; ?>
    </div>
  <?php else: ?>
