...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center">
    ...
    <p class="text-slate-400 mb-6">
      <?= $q !== '' ? 'We couldn\'t find any movies matching "'.h($q).'".' : 'No movies available right now.' ?>
    </p>
    <?php if($q !== ''): ?>
    <a href="/" class="inline-block rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 px-4 py-2 transition outline-none focus-visible:ring focus-visible:ring-sky-600">Clear search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
