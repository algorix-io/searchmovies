...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-12 text-center py-16 px-4 rounded-2xl border border-slate-800 bg-slate-900/50">
    ...
    <a href="/" class="inline-flex items-center justify-center rounded-xl bg-sky-600 text-white px-6 py-2.5 font-medium hover:bg-sky-500 outline-none focus:ring focus:ring-sky-400 transition">Clear search</a>
  </div>
  <?php else: ?>
