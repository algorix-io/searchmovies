...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <div class="mt-16 mb-16 text-center">
    ...
    <h2 class="text-2xl font-semibold text-slate-200">No movies found</h2>
    <p class="mt-2 text-slate-400">
      <?= $q !== '' ? 'We couldn\'t find any movies matching your search.' : 'There are no movies available right now.' ?>
    </p>
    <?php if ($q !== ''): ?>
    <a href="/" class="inline-block mt-6 rounded-xl border border-slate-700 px-6 py-2 hover:bg-slate-800 outline-none focus-visible:ring focus-visible:ring-sky-600 transition">Clear search</a>
    <?php endif; ?>
  </div>
  <?php else: ?>
