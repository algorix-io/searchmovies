...
<header class="border-b border-slate-800 sticky top-0 bg-slate-950/80 backdrop-blur">
  <div class="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
    <a href="/" class="text-xl font-extrabold brand-grad focus:outline-none focus:ring focus:ring-sky-600 rounded">🎬 <?=h(APP_NAME)?></a>
    <a href="/" class="text-sm underline text-slate-300 hover:text-white focus:outline-none focus:ring focus:ring-sky-600 rounded transition-colors">Back</a>
  </div>
</header>
