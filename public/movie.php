      ...
      <div class="mt-8">
        ...
        <div class="mt-3 flex flex-wrap gap-2">
          <?php foreach($links as $q=>$u): $go="/go.php?movie_id=".$movie['id']."&quality=".urlencode($q); ?>
            <a class="inline-flex items-center gap-2 rounded-xl border border-slate-700 px-3 py-2 hover:border-sky-600 hover:bg-slate-800 outline-none focus:ring focus:ring-sky-600" aria-label="Download in <?=h($q)?>" href="<?=$go?>" target="_blank" rel="nofollow noopener">
