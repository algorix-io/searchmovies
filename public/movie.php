...
<header class="border-b border-slate-800 sticky top-0 bg-slate-950/80 backdrop-blur">
  <div class="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
    <a href="/" class="text-xl font-extrabold brand-grad outline-none focus:ring focus:ring-sky-600 rounded transition">🎬 <?=h(APP_NAME)?></a>
    <a href="/" class="text-sm underline text-slate-300 hover:text-white outline-none focus:ring focus:ring-sky-600 rounded transition">Back</a>
  </div>
</header>
...
<footer class="border-t border-slate-800">
  <div class="max-w-4xl mx-auto px-4 py-6 text-slate-400 text-sm flex flex-wrap items-center gap-3">
    ...
    <span class="footer-tag">Powered by <a href="https://knowhub.uz" target="_blank" class="underline outline-none focus:ring focus:ring-sky-600 rounded transition hover:text-slate-300">KnowHub.uz</a></span>
  </div>
</footer>
</body></html>
